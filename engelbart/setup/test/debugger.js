...
class Debugger extends React.Component {
  constructor(props) {
    ...
    this.KNOBS = [
      ...
      { key: "readyGate", label: "Ready verdict", desc: "brainstorm(): whether the reader is ready to plan is the model's verdict on each turn, or asserted on every turn; either way the second question round closes the conversation, fitted list or not.", options: [["model", "model"], ["always", "always"]] },
