...
class Debugger extends React.Component {
  constructor(props) {
    ...
    this.KNOBS = [
      ...
      { key: "readyGate", label: "Plan offer gate", desc: "brainstorm(): use model readiness with a three-response cap, or force readiness immediately; neither depends on resource fitting.", options: [["model", "model"], ["always", "always"]] },
