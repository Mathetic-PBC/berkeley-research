...
class Debugger extends React.Component {
  constructor(props) {
    ...
    this.KNOBS = [
      ...
      { key: "readyGate", label: "Plan offer gate", desc: "brainstorm(): the plan is offered only on a turn where the model said the reader is ready, or on any turn once the fitted list exists.", options: [["model", "model"], ["always", "always"]] },
