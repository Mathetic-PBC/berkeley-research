...
function structuralIssue(out,purpose,input) {
  if (normalize(input.paper?.grounding) && !basis(out,input)) return 'Missing valid paper evidence and reproduce/interrogate/extend basis';
...
module.exports={normalize,rules,basis,structuralIssue,reviewPrompt,reviewPass};
